An Olympic array is defined to be an array in which every value is greater than or equal
to the sum of the values less than it. The sum of the values less than the minimum value
in the array is defined to be 0.

For example, {3, 2, 1} is an Olympic array because
1 is the minimum value and by definition the sum of the values less than it is 0. Since 1 is greater than 0,
